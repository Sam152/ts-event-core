...
2. [Key components](#key-components)
   1. [`CommandIssuer`](#commandissuersrccommandcommandissuerts)
      1. [Implementations](#implementations)
   2. [`AggregateRootRepository`](#aggregaterootrepositorysrcaggregateaggregaterootrepositoryts)
      1. [Implementations](#implementations)
   3. [`SnapshotStorage`](#snapshotstoragesrcaggregatesnapshotstoragets)
      1. [Implementations](#implementations)
